...
A Home Assistant integration that displays low battery and unavailable entities in a dedicated sidebar page.
...
4. Configure the low battery threshold (5-100%)
...
Both tables support:
- Sorting by name, area, or battery level
- Infinite scroll for large datasets
- Click on entity name to open entity details
